...
exports.FrontendApi = exports.FrontendApiFactory = exports.FrontendApiFp = exports.FrontendApiAxiosParamCreator = exports.CourierApi = exports.CourierApiFactory = exports.CourierApiFp = exports.CourierApiAxiosParamCreator = exports.VerificationFlowState = exports.VerifiableIdentityAddressViaEnum = exports.UpdateVerificationFlowWithLinkMethodMethodEnum = exports.UpdateVerificationFlowWithCodeMethodMethodEnum = exports.UpdateRegistrationFlowWithProfileMethodScreenEnum = exports.UpdateRecoveryFlowWithLinkMethodMethodEnum = exports.UpdateRecoveryFlowWithCodeMethodMethodEnum = exports.UpdateIdentityBodyStateEnum = exports.UiTextTypeEnum = exports.UiNodeTextAttributesNodeTypeEnum = exports.UiNodeScriptAttributesNodeTypeEnum = exports.UiNodeInputAttributesTypeEnum = exports.UiNodeInputAttributesOnloadTriggerEnum = exports.UiNodeInputAttributesOnclickTriggerEnum = exports.UiNodeInputAttributesNodeTypeEnum = exports.UiNodeInputAttributesAutocompleteEnum = exports.UiNodeImageAttributesNodeTypeEnum = exports.UiNodeAnchorAttributesNodeTypeEnum = exports.UiNodeTypeEnum = exports.UiNodeGroupEnum = exports.SettingsFlowState = exports.SessionAuthenticationMethodMethodEnum = exports.RegistrationFlowState = exports.RegistrationFlowActiveEnum = exports.RecoveryFlowState = exports.MessageDispatchStatusEnum = exports.MessageTemplateTypeEnum = exports.LoginFlowState = exports.LoginFlowActiveEnum = exports.IdentityPatchResponseActionEnum = exports.IdentityCredentialsTypeEnum = exports.IdentityStateEnum = exports.CreateIdentityBodyStateEnum = exports.CourierMessageType = exports.CourierMessageStatus = exports.ContinueWithVerificationUiActionEnum = exports.ContinueWithSettingsUiActionEnum = exports.ContinueWithSetOrySessionTokenActionEnum = exports.ContinueWithRedirectBrowserToActionEnum = exports.ContinueWithRecoveryUiActionEnum = exports.ConsistencyRequestParametersConsistencyEnum = exports.AuthenticatorAssuranceLevel = void 0;
exports.MetadataApi = exports.MetadataApiFactory = exports.MetadataApiFp = exports.MetadataApiAxiosParamCreator = exports.ListSessionsExpandEnum = exports.ListIdentitiesConsistencyEnum = exports.GetSessionExpandEnum = exports.GetIdentityIncludeCredentialEnum = exports.DeleteIdentityCredentialsTypeEnum = exports.IdentityApi = exports.IdentityApiFactory = exports.IdentityApiFp = exports.IdentityApiAxiosParamCreator = void 0;
...
const FrontendApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createNativeRegistrationFlow: (returnSessionTokenExchangeCode_1, returnTo_1, organization_1, ...args_1) => __awaiter(this, [returnSessionTokenExchangeCode_1, returnTo_1, organization_1, ...args_1], void 0, function* (returnSessionTokenExchangeCode, returnTo, organization, options = {}) {
        ...
        updateFedcmFlow: (updateFedcmFlowBody_1, ...args_1) => __awaiter(this, [updateFedcmFlowBody_1, ...args_1], void 0, function* (updateFedcmFlowBody, options = {}) {
            ...
            (0, common_1.assertParamExists)('updateFedcmFlow', 'updateFedcmFlowBody', updateFedcmFlowBody);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(updateFedcmFlowBody, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
    ...
    return {
        ...
        createFedcmFlow(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['FrontendApi.createFedcmFlow']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        createNativeLoginFlow(refresh, aal, xSessionToken, returnSessionTokenExchangeCode, returnTo, organization, via, options) {
            return __awaiter(this, void 0, void 0, function* () {
                var _a, _b, _c;
                const localVarAxiosArgs = yield localVarAxiosParamCreator.createNativeLoginFlow(refresh, aal, xSessionToken, returnSessionTokenExchangeCode, returnTo, organization, via, options);
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
         ...
         * @throws {RequiredError}
         */
        createNativeRegistrationFlow(returnSessionTokenExchangeCode, returnTo, organization, options) {
            return __awaiter(this, void 0, void 0, function* () {
                var _a, _b, _c;
                const localVarAxiosArgs = yield localVarAxiosParamCreator.createNativeRegistrationFlow(returnSessionTokenExchangeCode, returnTo, organization, options);
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
        ...
        updateFedcmFlow(updateFedcmFlowBody, options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['FrontendApi.updateFedcmFlow']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
...
class FrontendApi extends base_1.BaseAPI {
     ...
     */
    createFedcmFlow(options) {
        return (0, exports.FrontendApiFp)(this.configuration).createFedcmFlow(options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * This endpoint initiates a login flow for native apps that do not use a browser, such as mobile devices, smart TVs, and so on.  If a valid provided session cookie or session token is provided, a 400 Bad Request error will be returned unless the URL query parameter `?refresh=true` is set.  To fetch an existing login flow call `/self-service/login/flows?flow=<flow_id>`.  You MUST NOT use this endpoint in client-side (Single Page Apps, ReactJS, AngularJS) nor server-side (Java Server Pages, NodeJS, PHP, Golang, ...) browser applications. Using this endpoint in these applications will make you vulnerable to a variety of CSRF attacks, including CSRF login attacks.  In the case of an error, the `error.id` of the JSON response body can be one of:  `session_already_available`: The user is already signed in. `session_aal1_required`: Multi-factor auth (e.g. 2fa) was requested but the user has no session yet. `security_csrf_violation`: Unable to fetch the flow because a CSRF violation occurred.  This endpoint MUST ONLY be used in scenarios such as native mobile apps (React Native, Objective C, Swift, Java, ...).  More information can be found at [Ory Kratos User Login](https://www.ory.sh/docs/kratos/self-service/flows/user-login) and [User Registration Documentation](https://www.ory.sh/docs/kratos/self-service/flows/user-registration).
     * @summary Create Login Flow for Native Apps
     ...
     */
    createNativeRegistrationFlow(requestParameters = {}, options) {
        return (0, exports.FrontendApiFp)(this.configuration).createNativeRegistrationFlow(requestParameters.returnSessionTokenExchangeCode, requestParameters.returnTo, requestParameters.organization, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * This endpoint initiates a settings flow for API clients such as mobile devices, smart TVs, and so on. You must provide a valid Ory Kratos Session Token for this endpoint to respond with HTTP 200 OK.  To fetch an existing settings flow call `/self-service/settings/flows?flow=<flow_id>`.  You MUST NOT use this endpoint in client-side (Single Page Apps, ReactJS, AngularJS) nor server-side (Java Server Pages, NodeJS, PHP, Golang, ...) browser applications. Using this endpoint in these applications will make you vulnerable to a variety of CSRF attacks.  Depending on your configuration this endpoint might return a 403 error if the session has a lower Authenticator Assurance Level (AAL) than is possible for the identity. This can happen if the identity has password + webauthn credentials (which would result in AAL2) but the session has only AAL1. If this error occurs, ask the user to sign in with the second factor or change the configuration.  In the case of an error, the `error.id` of the JSON response body can be one of:  `security_csrf_violation`: Unable to fetch the flow because a CSRF violation occurred. `session_inactive`: No Ory Session was found - sign in a user first.  This endpoint MUST ONLY be used in scenarios such as native mobile apps (React Native, Objective C, Swift, Java, ...).  More information can be found at [Ory Kratos User Settings & Profile Management Documentation](../self-service/flows/user-settings).
     * @summary Create Settings Flow for Native Apps
     ...
     */
    createNativeVerificationFlow(requestParameters = {}, options) {
        return (0, exports.FrontendApiFp)(this.configuration).createNativeVerificationFlow(requestParameters.returnTo, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Calling this endpoint invalidates all except the current session that belong to the logged-in user. Session data are not deleted.
     * @summary Disable my other sessions
     ...
     */
    updateFedcmFlow(requestParameters, options) {
        return (0, exports.FrontendApiFp)(this.configuration).updateFedcmFlow(requestParameters.updateFedcmFlowBody, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Use this endpoint to complete a login flow. This endpoint behaves differently for API and browser flows.  API flows expect `application/json` to be sent in the body and responds with HTTP 200 and a application/json body with the session token on success; HTTP 410 if the original flow expired with the appropriate error messages set and optionally a `use_flow_id` parameter in the body; HTTP 400 on form validation errors.  Browser flows expect a Content-Type of `application/x-www-form-urlencoded` or `application/json` to be sent in the body and respond with a HTTP 303 redirect to the post/after login URL or the `return_to` value if it was set and if the login succeeded; a HTTP 303 redirect to the login UI URL with the flow ID containing the validation errors otherwise.  Browser flows with an accept header of `application/json` will not redirect but instead respond with HTTP 200 and a application/json body with the signed in identity and a `Set-Cookie` header on success; HTTP 303 redirect to a fresh login flow if the original flow expired with the appropriate error messages set; HTTP 400 on form validation errors.  If this endpoint is called with `Accept: application/json` in the header, the response contains the flow without a redirect. In the case of an error, the `error.id` of the JSON response body can be one of:  `session_already_available`: The user is already signed in. `security_csrf_violation`: Unable to fetch the flow because a CSRF violation occurred. `security_identity_mismatch`: The requested `?return_to` address is not allowed to be used. Adjust this in the configuration! `browser_location_change_required`: Usually sent when an AJAX request indicates that the browser needs to open a specific URL. Most likely used in Social Sign In flows.  More information can be found at [Ory Kratos User Login](https://www.ory.sh/docs/kratos/self-service/flows/user-login) and [User Registration Documentation](https://www.ory.sh/docs/kratos/self-service/flows/user-registration).
     * @summary Submit a Login Flow
    ...
    return {
        ...
        isAlive(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['MetadataApi.isAlive']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
        /**
        ...
        isReady(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const localVarOperationServerIndex = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const localVarOperationServerBasePath = (_c = (_b = base_1.operationServerMap['MetadataApi.isReady']) === null || _b === void 0 ? void 0 : _b[localVarOperationServerIndex]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
            });
        },
    };
